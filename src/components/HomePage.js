    ...
    return (
        <>
            ...
            <div className="style-border">
                <div id="intro_section" className="main-intro w-4/5 my-36 row text-center mx-auto flex justify-center items-center">
                        <h1 className="main-title row justify-center">Alex Grimes</h1>
