            ...
            <div className="flex flex-col min-h-screen my-32">
                <div className="flex-grow d-flex align-items-center row mx-auto w-75 bg-cover px-32 py-28" style={{ backgroundImage: `url(${forestPath})`}}>
                    <div className="flex-grow w-3/4 mx-auto px-20 pb-24 pt-10 d-flex row fadeInTop rounded bg-lemonChiffon bg-opacity-90">
                        ...
                        <div>
                            <h5 className="text-xl">Full-Stack Developer trained in a 400+ hour Software Engineering course through General Assembly. I am very familiar with React, Node.js, Python (Django), including many more frameworks and languages. </h5>
                            <br/>
                            <h5 className="text-xl">My previous job as an accountant was more than accounting work. One of my projects was setting up an online expense system and training employees, as well as creating a MS Work Automate program that would send employee's submitted pre-trip business applications to their specific approvers. I took the time to review all the questions on the paper-based form and narrowed it down to 10 questions on MS Forms. The outcome was very successful; it reduced the amount of time employees spent on sending pre-trip business applications, quicker time submitting to their approvers, and of course all online.</h5>
                            <br/>
                            <h5 className="text-xl">Ever since I took on the challenge to learn how to write programs through MS Automate, I have been excited to see what more I can do to help reduce time spent on tasks that need to be done. </h5>
                            <br/>
                            <h5 className="text-xl">I'm a thorough thinker, organized, and very ambitious when it comes to coding projects. </h5>
                        </div>
                    </div>
                </div>
            </div>
